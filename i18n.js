  ...
  const pricing = {
    de: `
      <article class="surface-card pricing-card pricing-card--s">
        ...
        <button class="pricing-card__image-button pricing-card__jump pricing-card__jump--s" type="button" data-package-request="Paket S: Das Kickstart-Setup" onclick="return window.prefillService('Paket S: Das Kickstart-Setup');" aria-label="Paket S unverbindlich anfragen">
        ...
        <div id="pricing-details-s" class="pricing-card__details" hidden>
          ...
          <button class="button pricing-card__cta pricing-card__cta--s" type="button" data-package-request="Paket S: Das Kickstart-Setup" onclick="return window.prefillService('Paket S: Das Kickstart-Setup');">Unverbindlich anfragen</button>
        </div>
      </article>
      <article class="surface-card pricing-card pricing-card--m">
        <p class="offer-card__index">Paket M</p>
        <button class="pricing-card__image-button pricing-card__jump pricing-card__jump--m" type="button" data-package-request="Paket M: Der MVP-Builder" onclick="return window.prefillService('Paket M: Der MVP-Builder');" aria-label="Paket M unverbindlich anfragen">
        ...
        <div id="pricing-details-m" class="pricing-card__details" hidden>
          ...
          <button class="button pricing-card__cta pricing-card__cta--m" type="button" data-package-request="Paket M: Der MVP-Builder" onclick="return window.prefillService('Paket M: Der MVP-Builder');">Unverbindlich anfragen</button>
        </div>
      </article>
      <article class="surface-card pricing-card pricing-card--l">
        <p class="offer-card__index">Paket L</p>
        <button class="pricing-card__image-button pricing-card__jump pricing-card__jump--l" type="button" data-package-request="Paket L: Der Solo-Founder Companion" onclick="return window.prefillService('Paket L: Der Solo-Founder Companion');" aria-label="Paket L unverbindlich anfragen">
